...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/Users/matteo/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/theprimeagen/harpoon"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/matteo/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  playground = {
    loaded = true,
    path = "/Users/matteo/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/Users/matteo/.local/share/nvim/site/pack/packer/start/rose-pine",
